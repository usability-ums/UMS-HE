...
?>
<p></p>
<form name="form1" action="modifydefect.php" method="POST" onsubmit="return docheck1()">
<table>
<tr>
<td>Project Name</td>
...
?>
	...
	<td><a href="edit_defect.php?prop_id=<?php printf("%s",$myrow["id"]); ?>" target="home">Edit</a></td>
	</tr>
<?php
} while ($myrow = mysql_fetch_array($result));
