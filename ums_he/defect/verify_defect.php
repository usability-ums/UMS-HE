...
<body id="dt_example">
<fieldset>
<legend>VERIFY DEFECT</legend>
<?php
if($_POST["pid"] ==""){
?>
<p></p>
<form name="form1" action="verify_defect.php" method="POST" onsubmit="return docheck1()">
<table>
<tr>
<td>Project Name</td>
...
$sql = "SELECT * FROM defect WHERE project='$_POST[pid]' AND status='Resolved'";
$result = mysql_query($sql,$con);
