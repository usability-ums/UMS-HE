...
<body>
<fieldset>
<legend>DELETE SUB PROJECT</legend>
<p></p>
<script>
    function docheck(){
...
<form name="form" action="hdsubproject.php" method="POST" onsubmit="return docheck()">
<table>
<tr>
<td>Sub Project Name</td><td> :
<select name="id" style="width:60mm">
<option value=""> - SELECT SUB PROJECT NAME -</option>
<?php
require("../library/connection.php");
$sql = "SELECT DISTINCT subproject FROM dfproject";
